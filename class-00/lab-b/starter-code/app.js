...
let sum = (a, b, c, d,) => add(a+b+c+d);
//This gives me 10, but also adds an undefined number with NaN being the final result of the function. Very interesting. At least it is adding!
...
//I cannot get this to work, I don't know if it can be used in this instance. How would I tell the one line code that I don't have a parameter? Is this broken because of the constructor function?
...
//cannot use arrow functions on prototypes or constructors
...
//joe.scopeArrow is an incorrect function. This represents the student's name I believe. 
// 3. Explain why "this" is different when an arrow function is used.
//Arrow functions do not have their own 'this', and must use a previously stated objects. 
